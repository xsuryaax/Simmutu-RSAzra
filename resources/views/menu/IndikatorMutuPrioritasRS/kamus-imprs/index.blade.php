...
@section('title', 'Kamus IMPRS')

@section('page-title')
    <div class="page-header">
        <div class="page-header-left">
            <h3>Kamus Indikator Mutu Prioritas RS</h3>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center gap-3">
                <h5 class="card-title mb-0">Kamus Indikator Mutu Prioritas RS</h5>

                <a href="{{ route('kamus-imprs.create') }}" class="btn btn-primary btn-sm">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('kamus-imprs.edit', $m->id) }}"
                                                class="btn btn-warning btn-sm">
                                                <i class="bi bi-pencil"></i>
                                            </a>

                                            <form action="{{ route('kamus-imprs.destroy', $m->id) }}" method="POST"
