...
@section('title', 'Edit Kamus IMPRS')

@section('page-title')
    <div class="page-header">
        <div class="page-header-left">
            <h3>Edit Kamus Indikator Mutu Prioritas RS</h3>
            <p class="text-subtitle text-muted">
                Halaman untuk mengelola kamus indikator mutu prioritas rs dalam sistem.
            </p>
        </div>
                ...
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            Form Edit Kamus Indikator Mutu Prioritas RS
                        </li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">Form Edit Kamus Indikator Mutu Prioritas RS</h4>
                    </div>

                    <div class="card-content">
                        <div class="card-body">

                            <form action="{{ route('kamus-imprs.update', $data->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <select name="imprs_id" class="form-select">
                                                    <option value="">Pilih Indikator</option>

                                                    @foreach ($indikator as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ $item->id == $data->imprs_id ? 'selected' : '' }}>
                                                            {{ $item->nama_imprs }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                ...
                                <div class="mt-4">
                                    ...
                                    <a href="{{ route('kamus-imprs.index') }}" class="btn btn-secondary">Kembali</a>
                                </div>
