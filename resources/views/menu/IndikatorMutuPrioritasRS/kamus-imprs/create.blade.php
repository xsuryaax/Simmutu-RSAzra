...
<div class="page-header">
    <div class="page-header-left">
        <h3>Form Tambah Kamus Indikator Mutu Prioritas RS</h3>
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        Form Tambah Kamus Indikator Mutu Prioritas RS
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="col-md-12 col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Form Tambah Kamus Indikator Mutu Prioritas RS</h4>
                </div>

                <div class="card-content">
                    <div class="card-body">

                        <form action="{{ route('kamus-imprs.store') }}" method="POST">
                            @csrf
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <select name="imprs_id" class="form-select">
                                                ...
                                                <option value="{{ $item->id }}">{{ $item->nama_imprs }}
                                                </option>
                                                @endforeach
                                            </select>
                                        </div>
