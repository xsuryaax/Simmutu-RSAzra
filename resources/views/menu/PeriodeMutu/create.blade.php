                ...
                <form action="{{ route('periode-mutu.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_periode"
                            ...
                            placeholder="Contoh: Periode Mutu 2025" value="{{ old('nama_periode') }}" required>
                        @error('nama_periode')
                    ...
                    {{-- DEADLINE INPUT BULANAN --}}
                    <div class="mb-3">
                        <label class="form-label fw-semibold">
                            Deadline Pengisian (Tanggal)
                        </label>
                        <input type="number" name="deadline" class="form-control @error('deadline') is-invalid @enderror"
                            min="1" max="31" value="{{ old('deadline') }}" required>
                        <small class="text-muted">
                            Contoh: isi 5 berarti tiap bulan maksimal tanggal 5 bulan berikutnya.
                        </small>
                        @error('deadline')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
