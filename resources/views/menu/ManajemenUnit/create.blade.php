        ...
        <div class="page-title">
            <div class="row">
                ...
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Tambah Unit</h3>
                    <p class="text-subtitle text-muted">Silakan isi data unit baru</p>
                </div>
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('manajemen-unit.index') }}">Manajemen Unit</a>
                            </li>
                                            ...
                                            <div class="col-12 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="deskripsi_unit" name="deskripsi_unit" rows="3"
                                                        ...
                                                        placeholder="Masukkan keterangan unit">{{ old('deskripsi_unit') }}</textarea>
                                            ...
                                            <div class="col-3 mb-3">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="status_unit"
                                                        id="status_aktif" value="aktif" {{ old('status_unit', 'aktif') == 'aktif' ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="status_aktif">Aktif</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="status_unit"
                                                        id="status_non_aktif" value="non-aktif" {{ old('status_unit') == 'non-aktif' ? 'checked' : '' }}>
