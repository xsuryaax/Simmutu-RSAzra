...
<div class="page-heading">
    ...
    <div class="row">
        <div class="col-6 col-lg-3 col-md-6">
            <div class="card">
                <div class="card-body px-4 py-4-5 d-flex align-items-center">
                    <div class="stats-icon purple"><i class="bi bi-people"></i></div>
                    <div class="ms-3">
        ...
        <div class="col-6 col-lg-3 col-md-6">
            <div class="card">
                <div class="card-body px-4 py-4-5 d-flex align-items-center">
                    <div class="stats-icon green"><i class="bi bi-check-circle"></i></div>
                    <div class="ms-3">
        ...
        <div class="col-6 col-lg-3 col-md-6">
            <div class="card">
                <div class="card-body px-4 py-4-5 d-flex align-items-center">
                    <div class="stats-icon red"><i class="bi bi-x-circle"></i></div>
                    <div class="ms-3">
                        <h6 class="text-muted font-semibold">Role Non-Aktif</h6>
                    ...
                    <form action="{{ route('manajemen-role.store') }}" method="POST">
                        ...
                        <div class="form-group has-icon-left mb-3">
                            ...
                            <div class="position-relative">
                                <input type="text" name="nama_role" class="form-control" placeholder="Contoh: Admin" required>
