                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select id="tipe_indikator" name="tipe_indikator"
                                                ...
                                                <option value="lokal"
                                                    {{ old('tipe_indikator', $indikator->tipe_indikator) == 'lokal' ? 'selected' : '' }}>
                                                    Lokal</option>
                                                <option value="nasional"
                                                    {{ old('tipe_indikator', $indikator->tipe_indikator) == 'nasional' ? 'selected' : '' }}>
                                                    Nasional</option>
                                            </select>
                                            ...
                                            <div class="d-flex gap-4 mt-1">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        name="status_indikator" value="aktif"
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        name="status_indikator" value="non-aktif"
