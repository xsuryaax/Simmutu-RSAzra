                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form action="{{ route('master-impu.update', $indikator->id) }}" method="POST" class="form form-vertical">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12 d-flex justify-content-end">
                                                <a href="{{ route('master-impu.index') }}" class="btn btn-light-secondary me-2">
                                                    Kembali
                                                </a>
