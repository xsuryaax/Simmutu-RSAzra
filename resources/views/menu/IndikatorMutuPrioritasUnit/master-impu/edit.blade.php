...
@section('title', 'Edit Data IMPU')

@section('page-title')
    <div class="page-header">
        <div class="page-header-left">
            <h3>Form Edit Master Indikator Mutu Prioritas Unit</h3>
                ...
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            Form Edit Master Indikator Mutu Prioritas Unit
                        </li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Form Edit Indikator Mutu Prioritas Unit</h4>
                    </div>

                    <div class="card-content">
                        <div class="card-body">

                            <form action="{{ route('master-impu.update', $indikator->id) }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select id="tipe_indikator_unit" name="tipe_indikator_unit"
                                                ...
                                                <option value="lokal"
                                                    {{ old('tipe_indikator_unit', $indikator->tipe_indikator_unit) == 'lokal' ? 'selected' : '' }}>
                                                    Lokal</option>
                                                <option value="nasional"
                                                    {{ old('tipe_indikator_unit', $indikator->tipe_indikator_unit) == 'nasional' ? 'selected' : '' }}>
                                                    Nasional</option>
                                            </select>
                                            ...
                                            <div class="d-flex gap-4 mt-1">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        name="status_indikator_unit" value="aktif"
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        name="status_indikator_unit" value="non-aktif"
