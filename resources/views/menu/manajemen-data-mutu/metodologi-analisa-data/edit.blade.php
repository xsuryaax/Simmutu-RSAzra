...
@section('page-title')
    <div class="page-header">
        <div class="page-header-left">
            <h3>Edit Metodologi Analisa Data</h3>
            <p class="text-subtitle text-muted">
                Halaman untuk mengedit Metodologi Analisa Data mutu RS Azra.
            </p>
        </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Edit Metodologi Analisa Data</h4>
            </div>
