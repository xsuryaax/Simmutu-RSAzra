...
@section('page-title')
    <div class="page-header">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Edit Frekuensi Analisa Data</h3>
            <p class="text-subtitle text-muted">
                Halaman untuk mengedit Frekuensi Analisa Data mutu RS Azra.
            </p>
        </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Edit Frekuensi Analisa Data</h4>
            </div>
