...
@section('title', 'Tambah Interpretasi Data')

@section('page-title')
    <div class="page-header">
        <div class="page-header-left">
            <h3>Form Tambah Interpretasi Data</h3>
    ...
    <section class="section" id="basic-vertical-layouts">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('interpretasi-data.store') }}" method="POST" class="form form-vertical">
                    @csrf
