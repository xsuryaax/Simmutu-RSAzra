        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Daftar seluruh frekuensi pengumpulan data</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Frekuensi Pengumpulan Data</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <tbody>
                            @foreach($frekuensiPengumpulanData as $i => $row)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('frekuensi-pengumpulan-data.edit', $row->id) }}"
