...
@section('page-title')
    <div class="page-header">
        <div class="page-header-left">
            <h3>Form Tambah Jenis Indikator</h3>
    ...
    <section class="section" id="basic-vertical-layouts">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Form Tambah Jenis Indikator</h4>
            </div>

            <div class="card-body">

                <form action="{{ route('jenis-indikator.store') }}" method="POST" class="form form-vertical">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" id="nama_jenis_indikator" name="nama_jenis_indikator"
                                    ...
                                    value="{{ old('nama_jenis_indikator') }}"
