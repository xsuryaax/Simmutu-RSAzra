                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form action="{{ route('master-indikator-unit.store') }}" method="POST" class="form form-vertical">
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" id="nama_indikator_unit" name="nama_indikator_unit"
                                                    ...
                                                    value="{{ old('nama_indikator_unit') }}" placeholder="Masukkan nama indikator" required>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select id="tipe_indikator_unit" name="tipe_indikator_unit"
                                                    ...
                                                    <option value="lokal" {{ old('tipe_indikator_unit') == 'lokal' ? 'selected' : '' }}>Lokal</option>
                                                    <option value="nasional" {{ old('tipe_indikator_unit') == 'nasional' ? 'selected' : '' }}>Nasional</option>
                                            ...
                                            <div class="col-12 d-flex justify-content-end">
                                                <a href="{{ route('master-indikator-unit.index') }}"
