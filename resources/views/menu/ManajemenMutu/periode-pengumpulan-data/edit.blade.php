...
@section('title', 'Edit Periode Pengumpulan Data')

@section('page-title')
    <div class="page-header">
        <div class="page-header-left">
            <h3>Form Edit Periode Pengumpulan Data</h3>
    ...
    <section class="section" id="basic-vertical-layouts">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Form Edit Periode Pengumpulan Data</h4>
            </div>

            <div class="card-body">

                <form action="{{ route('periode-pengumpulan-data.update', $periodePengumpulanData->id) }}"
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" id="nama_periode_pengumpulan_data"
                                    ...
                                    value="{{ old('nama_periode_pengumpulan_data', $periodePengumpulanData->nama_periode_pengumpulan_data) }}"
