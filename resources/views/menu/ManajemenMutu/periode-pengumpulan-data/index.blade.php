...
@section('page-title')
    <div class="page-header">
        <div class="page-header-left">
            <h3>Periode Pengumpulan Data</h3>
    ...
    <section class="section">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5>Periode Pengumpulan Data</h5>

                <a href="{{ route('periode-pengumpulan-data.create') }}" class="btn btn-primary btn-sm">
                    <i class="bi bi-plus"></i> Tambah Periode Pengumpulan Data
                </a>
            </div>
