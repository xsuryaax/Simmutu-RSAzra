...
@section('title', 'Frekuensi Analisis Data')
                        ...
                        <tbody>
                            @foreach ($frekuensiAnalisisData as $i => $row)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('frekuensi-analisis-data.edit', $row->id) }}"
                                            class="btn btn-warning btn-sm">
                                            <i class="bi bi-pencil"></i>
                                        </a>

                                        <form action="{{ route('frekuensi-analisis-data.destroy', $row->id) }}"
