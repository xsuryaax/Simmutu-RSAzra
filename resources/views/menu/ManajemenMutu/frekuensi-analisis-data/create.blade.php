...
@section('title', 'Tambah Frekuensi Analisis Data')

@section('page-title')
    <div class="page-header">
        <div class="page-header-left">
            <h3>Form Tambah Frekuensi Analisis Data</h3>
            <p class="text-subtitle text-muted">
                Halaman untuk mengelola frekuensi analisis data dalam sistem.
            </p>
        </div>
                ...
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            Form Tambah Frekuensi Analisis Data
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <section class="section" id="basic-vertical-layouts">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Form Tambah Frekuensi Analisis Data</h4>
            </div>
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-12 d-flex justify-content-end">
                                <a href="{{ route('frekuensi-analisis-data.index') }}" class="btn btn-light-secondary me-2">
                                    Kembali
                                </a>
