    ...
    <section class="section">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5>Metode Pengumpulan Data</h5>

                <a href="{{ route('metode-pengumpulan-data.create') }}" class="btn btn-primary btn-sm">
                    <i class="bi bi-plus"></i> Tambah Metode Pengumpulan Data
                </a>
            </div>
