...
@section('title', 'Metodologi Analisis Data')
    ...
    <section class="section">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5>Penyajian Data</h5>

                <a href="{{ route('penyajian-data.create') }}" class="btn btn-primary btn-sm">
                    <i class="bi bi-plus"></i> Tambah Penyajian Data
                </a>
            </div>
