...
@section('title', 'Tambah Penyajian Data')

@section('page-title')
    <div class="page-header">
        <div class="page-header-left">
            <h3>Form Tambah Penyajian Data</h3>
    ...
    <section class="section" id="basic-vertical-layouts">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Form Tambah Penyajian Data</h4>
            </div>

            <div class="card-body">

                <form action="{{ route('penyajian-data.store') }}" method="POST" class="form form-vertical">
                    @csrf
