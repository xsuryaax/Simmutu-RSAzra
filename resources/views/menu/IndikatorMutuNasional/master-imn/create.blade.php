                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" id="nama_indikator_nasional" name="nama_indikator_nasional"
                                                    class="form-control @error('nama_indikator_nasional') is-invalid @enderror"
                                                    value="{{ old('nama_indikator_nasional') }}" placeholder="Masukkan nama indikator" required>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" id="target_indikator_nasional" name="target_indikator_nasional"
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <div class="d-flex gap-4 mt-1">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="status_indikator_nasional"
                                                            id="status_aktif" value="aktif"
