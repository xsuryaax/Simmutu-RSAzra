                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form action="{{ route('master-imn.update', $indikator->id) }}" method="POST"
                                            ...
                                            <div class="d-flex gap-4 mt-1">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        name="status_indikator_nasional" value="aktif"
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        name="status_indikator_nasional" value="non-aktif"
