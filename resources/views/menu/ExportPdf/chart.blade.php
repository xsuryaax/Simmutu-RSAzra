...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .rs-name { font-size: 12px; font-weight: bold; color: #1a3c6e; text-transform: uppercase; }
        .doc-title { font-size: 15px; font-weight: bold; color: #1a3c6e; }

        .ind-header { margin-bottom: 15px; }
        .ind-title { font-size: 14px; font-weight: bold; color: #1a2b4b; margin-bottom: 5px; }
        .ind-meta { font-size: 10px; color: #666; }

        .content-wrapper { display: table; width: 100%; border-spacing: 20px 0; margin-left: -20px; }
        .left-col { display: table-cell; width: 65%; vertical-align: top; }
        .right-col { display: table-cell; width: 35%; vertical-align: top; }

        .chart-container { text-align: center; padding: 10px; border: 1px solid #f1f4f8; border-radius: 8px; }
        .chart-image { width: 100%; height: auto; }

        .data-table { width: 100%; border-collapse: collapse; margin-top: 5px; }
        .data-table th { background: #1a3c6e; color: #fff; padding: 6px 4px; font-size: 9px; border: 1px solid #1a3c6e; }
        .data-table td { padding: 5px 4px; border: 1px solid #dde4f0; text-align: center; font-size: 9px; }
...
<div class="ind-header">
    ...
    <div class="ind-meta">
        ...
        <strong>Standar:</strong> {{ $indicator->arah_target === 'lebih_kecil' ? '≤' : '≥' }} {{ round($indicator->target_indikator) }}%
    </div>
</div>
