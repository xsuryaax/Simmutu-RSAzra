        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Tambah Cakupan Data</h3>
                    <p class="text-subtitle text-muted">Silakan isi data cakupan data baru</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Tambah Cakupan Data</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-md-6 col-6">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Form Tambah Cakupan Data</h4>
                        </div>

                        <div class="card-content">
                            <div class="card-body">

                                <form action="{{ route('cakupan-data.store') }}" method="POST" class="form form-vertical">
                                    @csrf
