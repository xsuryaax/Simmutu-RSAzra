        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Frekuensi Analisis Data</h3>
                    <p class="text-subtitle text-muted">Daftar seluruh frekuensi analisis data</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Frekuensi Analisis Data</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <tbody>
                            @foreach($frekuensiAnalisisData as $i => $row)
                                <tr>
                                    ...
                                    <td>{{ $row->nama_frekuensi_analisis_data }}</td>
                                    <td>
                                        <a href="{{ route('frekuensi-analisis-data.edit', $row->id) }}" class="btn btn-warning btn-sm">
                                            <i class="bi bi-pencil"></i>
                                        </a>

                                        <form action="{{ route('frekuensi-analisis-data.destroy', $row->id) }}" method="POST"
