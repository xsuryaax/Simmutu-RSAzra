        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Tambah Metodologi Analisis Data</h3>
                    <p class="text-subtitle text-muted">Silakan isi data metodologi analisis data baru</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Tambah Frekuensi Pengumpulan Data</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="col-md-6 col-6">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Form Tambah Metodologi Analisis Data</h4>
                        </div>

                        <div class="card-content">
                            <div class="card-body">

                                <form action="{{ route('metodologi-analisis-data.store') }}" method="POST" class="form form-vertical">
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <input type="text" id="nama_metodologi_analisis_data" name="nama_metodologi_analisis_data"
                                                    ...
                                                    value="{{ old('nama_metodologi_analisis_data') }}"
